...
public class Instrucao {
    ...
    /**
     * Método que executa a operação contida no operacaoEnum
     * @return false para operações ADD e SUB e quando ZER resultar em falso. true para quando ZER resultar em verdadeiro.
     **/
